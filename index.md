...
<head>
    ...
    <title>Wraithstars's Item List</title>
    <script type="text/javascript">
        const itemListURL = "https://raw.githubusercontent.com/musedwraith/wraithstars-rimworld-list/master/StoreItems.json";
        const eventListURL = "https://raw.githubusercontent.com/musedwraith/wraithstars-rimworld-list/master/StoreEvents.json";
    </script>
</head>

<body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Wraithstars</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://www.twitch.tv/wraithstars">My Stream</a>
                </li>
            </ul>
        </div>
    </nav>
